  ...
  useEffect(() => {
    const generateThemeVariables = theme => {
      ...
      return {
        ...
        "--radius-container": theme.layout.radius.container.style === "rounded" ? theme.layout.radius.container.value : "0",
        "--radius-workspace": theme.layout.radius.workspace.style === "rounded" ? theme.layout.radius.workspace.value : "0",
        "--radius-shortcut": theme.layout.radius.shortcut.style === "rounded" ? theme.layout.radius.shortcut.value : "0",
        "--radius-control": theme.layout.radius.control.style === "rounded" ? theme.layout.radius.control.value : "0",
        ...
        "--widget-hover-shadow": theme.layout.widgets.hoverEffects ? "0 2px 8px rgba(0, 0, 0, 0.2)" : "none",
        ...
        "--search-button-background": theme.colors.search?.buttonBackground || "var(--primary-light)",
